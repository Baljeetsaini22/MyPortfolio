      ...
      <div className="w-full px-[7.5%] flex items-center justify-between shadow-md shadow-yellow-400">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="cursor-pointer inline-flex items-center gap-2 bg-yellow-400 text-black px-2 py-1 md:px-5 md:py-2 rounded-md font-medium hover:bg-yellow-300 transition"
          >
